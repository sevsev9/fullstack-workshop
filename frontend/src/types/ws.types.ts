...
// Lobby requests
export type LobbyCreateRequest = BaseMessage<
  "lobby_create",
  { user: string; lobbyName: string }
>;
export type LobbyJoinRequest = BaseMessage<
  "lobby_join",
  { user: string; lobbyName: string }
>;
export type LobbyLeaveRequest = BaseMessage<
  "lobby_leave",
  { user: string; lobbyName: string }
>;
export type LobbyKickRequest = BaseMessage<
  "lobby_kick",
  { user: string; lobbyName: string; target: string }
>;
export type LobbyChatRequest = BaseMessage<
  "lobby_chat",
  { user: string; lobbyName: string; message: string }
>;
export type LobbyListRequest = BaseMessage<
  "lobby_list",
  { lobbies: { name: string; full: boolean } }
>;

// Game requests
export type GameStartRequest = BaseMessage<
  "game_start",
  { user: string; lobbyName: string; mode: GameMode }
>;
export type GameMoveRequest = BaseMessage<
  "game_move",
  { user: string; lobbyName: string; move: Move }
>;
export type GameStateRequest = BaseMessage<
  "game_state",
  { user: string; lobbyName: string }
>;
export type GameEndRequest = BaseMessage<
  "game_end",
  { user: string; lobbyName: string }
>;

// Meta requests
export type GlobalChatRequest = BaseMessage<
  "global_chat",
...
// Lobby responses
export type LobbyCreateResponse = BaseMessage<
  "lobby_create",
  { success: boolean; lobbyName?: string; error?: string }
>;
export type LobbyJoinResponse = BaseMessage<
  "lobby_join",
  { success: boolean; lobbyName?: string; error?: string }
>;
export type LobbyLeaveResponse = BaseMessage<
  "lobby_leave",
  { success: boolean; lobbyName?: string; error?: string }
>;
export type LobbyKickResponse = BaseMessage<
  "lobby_kick",
  { success: boolean; lobbyName?: string; error?: string }
>;
export type LobbyKickedResponse = BaseMessage<
  "lobby_kicked",
  { lobbyName: string }
>;
export type LobbyChatResponse = BaseMessage<
  "lobby_chat",
  { user: string; lobbyName: string; message: string }
>;
export type LobbyListResponse = BaseMessage<
  "lobby_list",
  { lobbies: { name: string }[] }
>;
...
export type GameMoveResponse = BaseMessage<
  "game_move",
  { user: string; lobbyName: string; move: Move }
>;
...
// Meta responses
export type GlobalChatResponse = BaseMessage<
  "global_chat",
  { user: string; message: string }
>;
